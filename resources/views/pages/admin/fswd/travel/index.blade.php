...
@section('content')
    @include('pages.admin.fswd.travel.partials.modal')
        ...
        <div class="py-4">
            <div class="d-flex flex-md-row flex-column gap-4  align-items-center justify-content-between">
                <div class="search-box">
                    ...
                    <input type="text" data-table-id="travel-table" id="searchBox" data-action="search"
                        class="form-control form-control-solid w-250px ps-13" placeholder="Cari travel" />
                </div>
                <div class="d-flex flex-row justify-content-center justify-content-md-end w-100 gap-1">
                    ...
                    @else
                        @can($globalModule['create'])
                            <button data-bs-toggle="modal" data-bs-target="#add-travel-modal" class="btn btn-primary">
